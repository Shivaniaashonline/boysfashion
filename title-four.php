...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/title-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:35 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Title Four || shofixe</title>
                            ...
                            <div class="col-md-6">
                                <div class="banner-text text-left">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">title four</h2>
                                    </div>
                                </div>
                            </div>    
                            <div class="col-md-6">       
                                <div class="breadcrumbs text-right">
                                    <ul>
                                        ...
                                        <li class="text-capitalize">title four</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
