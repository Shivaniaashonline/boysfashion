...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/footer-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:38 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Footer Four || shofixe</title>
    ...
    <body>
        ...
        <div class="as-mainwrapper">
            <div class="bg-white">
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Footer Four</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li class="text-capitalize"><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">footer Four</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- common end -->
                <!-- footer start -->
                <footer class="footer-area text-center four">
