...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-newsletter.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:44 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Shortcode Newsletter || shofixe</title>
...
<body>
    ...
    <div class="as-mainwrapper">
        <div class="bg-white">
                        ...
                        <div class="col-lg-12">
                            <div class="banner-text text-center">
                                <div class="banner-title">
                                    <h2 class="text-uppercase">Shortcode Newsletter</h2>
                                </div>
                                <div class="breadcrumbs">
                                    <ul>
                                        <li><a href="index.html">Home</a> ></li>
                                        <li class="text-capitalize">Shortcode Newsletter</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="newsletter-area ptb-110 mt-90">
                <div class="container">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="news-right text-center">
                                <form action="#" id="mc-form" class="mc-form">
                                    ...
                                    <span class="d-none d-md-block"><input type="checkbox" name="agree">By Subscribing to our
