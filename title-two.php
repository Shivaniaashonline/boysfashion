...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/title-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:35 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Title Two || shofixe</title>
    ...
    <body>
        ...
        <div class="as-mainwrapper">
            <div class="bg-white">
                ...
                <!-- header end -->
                <!-- banner start -->
                <div class="banner-area checkout ptb-110">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="banner-text text-left">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Title Two</h2>
                                    </div>
