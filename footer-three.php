...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/footer-three.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:35 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Footer Three || shofixe</title>
            ...
            <div class="bg-white">
                                        ...
                                        <ul class="submenu-mainmenu">
                                            <li><a href="parallax-one.html"><i class="fa fa-circle"></i>Sliders<i
                                                ...
                                                <ul class="sub-submenu-mainmenu">
                                                    ...
                                                    <li><a href="parallax-one.html"><i class="fa fa-circle"></i>Parallax One</a>
                                                    </li>
                                                    <li><a href="parallax-two.html"><i class="fa fa-circle"></i>Parallax Two</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="menu-default.html"><i class="fa fa-circle"></i>Menu Style<i
                                                        class="fa fa-angle-right"></i></a>
                                                <ul class="sub-submenu-mainmenu">
                                                    <li><a href="menu-default.html"><i class="fa fa-circle"></i>Menu Style One</a>
                                                    </li>
                                                    <li><a href="menu-style-two.html"><i class="fa fa-circle"></i>Menu Style Two</a>
                                                    </li>
                                                    <li><a href="menu-style-three.html"><i class="fa fa-circle"></i>Menu Style
                                                            Three</a>
                                                    </li>
                                                    <li><a href="menu-style-four.html"><i class="fa fa-circle"></i>Menu Style
                                                            Four</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="title-one.html"><i class="fa fa-circle"></i>Page Title<i
                                                        class="fa fa-angle-right"></i></a>
                                                <ul class="sub-submenu-mainmenu">
                                                    <li><a href="title-one.html"><i class="fa fa-circle"></i>Title Style One</a>
                                                    </li>
                                                    <li><a href="title-two.html"><i class="fa fa-circle"></i>Title Style Two</a>
                                                    </li>
                                                    <li><a href="title-three.html"><i class="fa fa-circle"></i>Title Style Three</a>
                                                    </li>
                                                    <li><a href="title-four.html"><i class="fa fa-circle"></i>Title Style Four</a>
                                                    </li>
                                                    <li><a href="title-five.html"><i class="fa fa-circle"></i>Title Style Five</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="index-4.html"><i class="fa fa-circle"></i>Footer<i
                                                ...
                                                <ul class="sub-submenu-mainmenu">
                                                    <li><a href="footer-one.html"><i class="fa fa-circle"></i>Footer Style One</a>
                                                    </li>
                                                    <li><a href="footer-two.html"><i class="fa fa-circle"></i>Footer Style Two</a>
                                                    </li>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Footer Three</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li class="text-capitalize"><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">footer Three</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="common-area ptb-100">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae ipsum magnam cum quam,
                                    aliquid
                    ...
                    <div class="footer-middle-area ptb-60">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-3 col-lg-5 col-md-6">
                                    <div class="footer-widget address">
                                        ...
                                        <div class="single-footer-contact">    
                                            ...
                                            <div class="footer-contact-info">   
                                                <p>Telephone : (801) 2223 3337<br>Telephone : +032 225 501 172</p>
                                            </div>
                                        </div>    
                                        <div class="single-footer-contact">
                                            <div class="footer-icon"> 
                                            ...
                                            <div class="footer-contact-info">        
                                                <p>info@example.com<br>Web : www.example.com</p>
                                            </div>    
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-3 d-block d-md-none d-lg-block">
                                ...
                                <div class="col-lg-2 d-block d-md-none d-xl-block">
                                    <div class="footer-widget">
                                        <h5>HELP &amp; SUPPORT</h5>
                                        <ul>
                                    ...
                                    <div class="footer-menu text-center">
                                        <nav>
                                            <ul>
                                                ...
                                                <li class="d-block d-lg-none d-xl-block"><a href="wishlist.html">Wish List</a></li>
...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/footer-three.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:38 GMT -->
</html>
