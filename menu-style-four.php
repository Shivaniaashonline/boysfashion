...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/menu-style-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:35 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Menu Four || shofixe</title>
        ...
        <div class="as-mainwrapper">
            <div class="bg-white">
                ...
                <header class="header-area">
                    ...
                    <div class="mainmenu-area four text-center d-none d-lg-block">
                        <nav>
                            <div class="mainmenu">
                                <ul>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Menu Style Four</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li class="text-capitalize"><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">menu style four</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
