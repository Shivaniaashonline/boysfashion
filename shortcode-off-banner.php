...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-off-banner.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:45 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shortcode Off Banner || shofixe</title>
    ...
    <body>
        ...
        <div class="as-mainwrapper">
            <div class="bg-white">
                            ...
                            <div class="col-xs-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Shortcode Off Banner</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">Shortcode Off Banner</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- banner end -->
                <!-- shortcodes start -->
                <div class="off-banner-area mt-90">
