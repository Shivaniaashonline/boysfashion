...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-button.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:44 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shortcode Button || shofixe</title>
                                ...
                                <div class="col-lg-4">
                                    <div class="top-right">
                                        <div class="top-login-cart">
                                            <ul>
                                                <li class=" d-none d-sm-block"><a href="account.html">Login or Register</a></li>
                                ...
                                <ul>
                                        ...
                                        <ul class="submenu-mainmenu">
                                            ...
                                            <li><a href="menu-default.html"><i class="fa fa-circle"></i>Menu Style<i
                                                ...
                                                <ul class="sub-submenu-mainmenu">
                                                    ...
                                                    <li><a href="menu-style-two.html"><i class="fa fa-circle"></i>Menu Style Two</a>
                                                    </li>
                                                    <li><a href="menu-style-three.html"><i class="fa fa-circle"></i>Menu Style Three</a>
                                                    </li>
                                                    <li><a href="menu-style-four.html"><i class="fa fa-circle"></i>Menu Style Four</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="title-one.html"><i class="fa fa-circle"></i>Page Title<i
                                                ...
                                                <ul class="sub-submenu-mainmenu">
                                                    ...
                                                    <li><a href="title-three.html"><i class="fa fa-circle"></i>Title Style Three</a>
                                                    </li>
                                            ...
                                            <li><a href="index-4.html"><i class="fa fa-circle"></i>Footer<i
                                                ...
                                                <ul class="sub-submenu-mainmenu">
                                                    ...
                                                    <li><a href="footer-three.html"><i class="fa fa-circle"></i>Footer Style Three</a>
                                                    </li>
                                                    <li><a href="footer-four.html"><i class="fa fa-circle"></i>Footer Style Four</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                    ...
                                    <li class="shop"><a href="shop-grid-right-sidebar.html">Shop</a>
                                        <ul class="submenu-mainmenu">
                                            ...
                                            <li><a href="shop-grid-left-sidebar.html"><i class="fa fa-circle"></i>Shop Grid Left
                                                    Sidebar</a></li>
                                            <li><a href="shop-grid-right-sidebar.html"><i class="fa fa-circle"></i>Shop Grid Right
                                                    Sidebar</a></li>
                                            <li><a href="shop-list-left-sidebar.html"><i class="fa fa-circle"></i>Shop List Left
                                                    Sidebar</a></li>
                                            <li><a href="shop-list-right-sidebar.html"><i class="fa fa-circle"></i>Shop List Right
                                                    Sidebar</a></li>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Shortcode Button</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">Shortcode Button</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">          
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="padding">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        <button type="button" class="btn btn-outline-secondary">1</button>
                                        <button type="button" class="btn btn-outline-secondary">2</button>
                                        <div class="btn-group pb-0" role="group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="Justified example">
                                    <button type="button" class="btn btn-outline-secondary">Left</button>
                                    <button type="button" class="btn btn-outline-secondary">Middle</button>
                                    <button type="button" class="btn btn-outline-secondary">Right</button>
                                </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="block padding mb-20">
                                    <div aria-label="Small button group" role="group" class="btn-group btn-group-md">
                                        <button class="btn btn-outline-secondary" type="button">Left</button>
                                        <button class="btn btn-outline-secondary" type="button">Middle</button>
                                        <button class="btn btn-outline-secondary" type="button">Right</button>
                                    </div>
                                ...
                                <div class="block padding mb-20">
                                    <div aria-label="Extra-small button group" role="group" class="btn-group btn-group-sm">
                                        <button class="btn btn-outline-secondary" type="button">Left</button>
                                        <button class="btn btn-outline-secondary" type="button">Middle</button>
                                        <button class="btn btn-outline-secondary" type="button">Right</button>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="shortcodes-title">
                                    <h4>Button Vetical Variation</h4>
                                </div>
                                <div aria-label="Vertical button group" role="group" class="btn-group-vertical">
                                    ...
                                    <div role="group" class="btn-group">
                                        <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"
                                            class="btn btn-outline-secondary dropdown-toggle" type="button" id="btnGroupVerticalDrop1"> Dropdown <span
                                    ...
                                    <div role="group" class="btn-group">
                                        <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"
                                            class="btn btn-outline-secondary dropdown-toggle" type="button" id="btnGroupVerticalDrop2"> Dropdown <span
                                                class="caret"></span> </button>
                                    ...
                                    <div role="group" class="btn-group">
                                        <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"
                                            class="btn btn-outline-secondary dropdown-toggle" type="button" id="btnGroupVerticalDrop3"> Dropdown <span
                                                class="caret"></span> </button>
                                    ...
                                    <div role="group" class="btn-group">
                                        <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"
                                            class="btn btn-outline-secondary dropdown-toggle" type="button" id="btnGroupVerticalDrop4"> Dropdown <span
                                                class="caret"></span> </button>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="btn-group">
                                    <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"
                                        class="btn btn-outline-secondary dropdown-toggle" type="button">Default <span class="caret"></span></button>
                                ...
                                <div class="btn-group">
                                    <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-success dropdown-toggle"
                                ...
                                <div class="btn-group">
                                    <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-info dropdown-toggle"
                                        type="button">Info <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#">Action</a></li>
                                        <li><a class="dropdown-item" href="#">Another action</a></li>
                                        <li><a class="dropdown-item" href="#">Something else here</a></li>
                                ...
                                <div class="btn-group">
                                    <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-warning dropdown-toggle"
                                ...
                                <div class="btn-group">
                                    <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-danger dropdown-toggle"
                                        type="button">Danger <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#">Action</a></li>
                                        <li><a class="dropdown-item" href="#">Another action</a></li>
                                        <li><a class="dropdown-item" href="#">Something else here</a></li>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="btn-group"> 
                                    ...
                                    <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-outline-secondary dropdown-toggle" type="button"> 
