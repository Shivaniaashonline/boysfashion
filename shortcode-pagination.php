...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-pagination.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:45 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shortcode Pagination || shofixe</title>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Shortcode Pagination</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">Shortcode Pagination</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="padding">
                                    <div data-example-id="aligned-pager-links" class="bs-example">
                                        <nav aria-label="...">
                                            <ul class="pager">
                                                <li class="previous pull-left"><a href="#"><span aria-hidden="true">←</span> Older</a></li>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="padding">
                                    <div data-example-id="disabled-pager" class="bs-example">
                                        <nav aria-label="...">
                                            <ul class="pager">
                                                <li class="previous disabled pull-left"><a href="#"><span aria-hidden="true">←</span> Older</a></li>
                                                <li class="next"><a href="#">Newer <span aria-hidden="true">→</span></a></li>
                                            </ul>
                                        </nav>
                                    </div>
