...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:44 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shortcode Contact || shofixe</title>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Shortcode Contact</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">Shortcode Contact</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <form id="contact-form-two" action="https://preview.hasthemes.com/shofixe-preview/shofixe/mail.php" method="post">
                                            <div class="form-top row">
                                                ...
                                                <div class="form-group col-md-6 col-lg-12">
                                                    ...
                                                    <input name="email" type="email" class="form-control" placeholder="l">
                                                </div>
                                                <div class="form-group col-md-6 col-lg-12">
