...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shop-list-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:42 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Shop List Left Sidebar || shofixe</title>
...
<body>
    ...
    <div class="as-mainwrapper">
        <div class="bg-white">
            ...
            <!-- header end -->
            <!-- banner start -->
            <div class="banner-area ptb-110 shop-list-left">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="shop-left-sidebar">
                                <div class="single-left-widget">
                                    <div class="section-title">
                                        ...
                                        <ul>
                                            <li class="active"><a href="#"><i class="fa fa-angle-right"></i>Men's
                                                    Collection
                                                    (275)</a></li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Women's Collection
                                                    (320)</a></li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Kid's Collection (275)</a>
                                            </li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Accessories (220)</a></li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Bag's Collection (175)</a>
                                            </li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Shoes Collection (150)</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="single-left-widget">
                                    <div class="section-title">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Cotton Blends (150)</a>
                                            </li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Lilen (120)</a></li>
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Polister Blends (175)</a>
                                            </li>
                                ...
                                <div class="single-left-widget">
                                    <div class="section-title">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#"><i class="fa fa-angle-right"></i>Dolce &amp; Gabbana
                                                    (175)</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-9 order-lg-2 order-1">
                            <div class="row">
                                <div class="shop-item-filter d-flex">
                                    <div class="col-xl-3 col-lg-2 col-5">
                                        <div class="shop-tab clearfix">
                                            <!-- Nav tabs -->
                                            <ul class="nav" role="tablist">
                                                <li role="presentation"><a data-toggle="tab" role="tab"
                                                        aria-controls="grid" class="grid-view" href="#grid"><i
                                                            class="fa fa-th"></i></a></li>
                                                <li role="presentation"><a class="active" data-toggle="tab" role="tab"
                                                        aria-controls="list" class="list-view" href="#list"><i
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-7">
                                        <div class="page-menu float-right">
                                            <ul>
                                                ...
                                                <li><a href="#">2</a></li>
                                                <li class="d-block d-sm-none d-md-block"><a href="#">3</a></li>
                                                <li class="d-block d-sm-none d-md-block"><a href="#">4</a></li>
                            ...
                            <div class="tab-content mt-25">
                                <div id="grid" class="tab-pane" role="tabpanel">
                                    <div class="row">
                                                    ...
                                                    <div class="single-product-img clearfix">
                                                        ...
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                                                <p>Duis autem vel eum iriure dolor in hendrerit in tate
                                                                    velit esse
                                                                    lestiesequat </p>
                                                                <ul>
                                        ...
                                        <div class="col-lg-12 col-width hidden-md hidden-sm">
                                            <div class="single-product mb-30">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                ...
                                <div id="list" class="tab-pane show active" role="tabpanel">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="row">
                                                            ...
                                                            <div class="col-xl-9 col-lg-8 col-md-8">
                                                                <div class="single-product-info mt-30 clearfix">
                                                                    ...
                                                                    <p>Lorem ipsum dolor sit amet, consectetur
                                                                        adipiscing elit, sed
                                                                        do eiusmod tempor incididunt utore et dolore
                                                                        magna aliqua.
                                                                        Ut enim ad minim veniam, quis nostrud
                                                                        exercitation ullamco
                                                                        laboris nisi ut aliquip reprehenderit. </p>
                                                                </div>
                            ...
                            <div class="row">
                                <div class="shop-item-filter margin-none d-flex">
                                    <div class="col-xl-3 col-lg-2 col-5">
                                        <div class="shop-tab clearfix">
                                            <!-- Nav tabs -->
                                            <ul class="nav" role="tablist">
