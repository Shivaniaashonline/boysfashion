...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-dropdown.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:44 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shortcode Dropdown || shofixe</title>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Shortcode Dropdown</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">Shortcode Dropdown</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">          
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="dropdown">
                                    <a class="btn btn btn-outline-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="btn-group dropup">
                                    <a class="btn btn btn-outline-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
