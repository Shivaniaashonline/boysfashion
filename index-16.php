...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/index-16.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:30 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Home Page Sixteen || shofixe</title>
    ...
    <div class="as-mainwrapper">
        <div class="bg-white">
            ...
            <header class="header-area">
                <div class="header-top-area ptb-10 d-none d-lg-block">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                    ...
                                    <ul>
                                        <li><a href="account.html">My Account <i class="fa fa-angle-down"></i></a>
                                            <ul class="submenu-mainmenu">
                                                ...
                                                <li><a href="account.html"><i class="fa fa-circle"></i>My Account</a>
                                                </li>
                                                <li><a href="wishlist.html"><i class="fa fa-circle"></i>My Wishlist</a>
                                                </li>
                                                <li><a href="cart.html"><i class="fa fa-circle"></i>My Cart</a></li>
                                                <li><a href="checkout.html"><i class="fa fa-circle"></i>Checkout</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="language"><a href="#"><img src="img/icon/eng.png" alt="">English <i
                            ...
                            <div class="col-lg-4">
                                <div class="top-right">
                                    <div class="top-login-cart">
                                        <ul>
                                            <li class=" d-none d-sm-block"><a href="account.html">Login or Register</a>
                                            </li>
                                            <li class=" d-none d-sm-block"><a href="checkout.html">Checkout</a></li>
                                            <li><a href="cart.html"><img src="img/icon/cart_red.png" alt="cart">Cart
                                                    (3)</a>
                                                <ul class="submenu-mainmenu">
                ...
                <div class="mainmenu-area text-center d-none d-lg-block">
                    <nav>
                        <div class="mainmenu">
                            <ul>
                                ...
                                <li><a href="index.html">Features</a>
                                    <ul class="submenu-mainmenu">
                                        <li><a href="parallax-one.html"><i class="fa fa-circle"></i>Sliders<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-submenu-mainmenu">
                                                <li><a href="slider-one.html"><i class="fa fa-circle"></i>Slider One</a>
                                                </li>
                                                <li><a href="slider-two.html"><i class="fa fa-circle"></i>Slider Two</a>
                                                </li>
                                                <li><a href="video-one.html"><i class="fa fa-circle"></i>Video One</a>
                                                </li>
                                                <li><a href="video-two.html"><i class="fa fa-circle"></i>Video Two</a>
                                                </li>
                                                <li><a href="parallax-one.html"><i class="fa fa-circle"></i>Parallax
                                                        One</a></li>
                                                <li><a href="parallax-two.html"><i class="fa fa-circle"></i>Parallax
                                                        Two</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="menu-default.html"><i class="fa fa-circle"></i>Menu Style<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-submenu-mainmenu">
                                                <li><a href="menu-default.html"><i class="fa fa-circle"></i>Menu Style
                                                        One</a></li>
                                                <li><a href="menu-style-two.html"><i class="fa fa-circle"></i>Menu Style
                                                        Two</a>
                                                </li>
                                                <li><a href="menu-style-three.html"><i class="fa fa-circle"></i>Menu
                                                        Style Three</a>
                                                </li>
                                                <li><a href="menu-style-four.html"><i class="fa fa-circle"></i>Menu
                                                        Style Four</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="title-one.html"><i class="fa fa-circle"></i>Page Title<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-submenu-mainmenu">
                                                <li><a href="title-one.html"><i class="fa fa-circle"></i>Title Style
                                                        One</a></li>
                                                <li><a href="title-two.html"><i class="fa fa-circle"></i>Title Style
                                                        Two</a></li>
                                                <li><a href="title-three.html"><i class="fa fa-circle"></i>Title Style
                                                        Three</a>
                                                </li>
                                                <li><a href="title-four.html"><i class="fa fa-circle"></i>Title Style
                                                        Four</a></li>
                                                <li><a href="title-five.html"><i class="fa fa-circle"></i>Title Style
                                                        Five</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="index-4.html"><i class="fa fa-circle"></i>Footer<i
                                                    class="fa fa-angle-right right"></i></a>
                                            <ul class="sub-submenu-mainmenu">
                                                <li><a href="footer-one.html"><i class="fa fa-circle"></i>Footer Style
                                                        One</a></li>
                                                <li><a href="footer-two.html"><i class="fa fa-circle"></i>Footer Style
                                                        Two</a></li>
                                                <li><a href="footer-three.html"><i class="fa fa-circle"></i>Footer Style
                                                        Three</a>
                                                </li>
                                                <li><a href="footer-four.html"><i class="fa fa-circle"></i>Footer Style
                                                        Four</a>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <li class="shop"><a href="shop-grid-right-sidebar.html">Shop</a>
                                    <ul class="submenu-mainmenu">
                                        ...
                                        <li><a href="shop-grid-left-sidebar.html"><i class="fa fa-circle"></i>Shop Grid
                                                Left
                                                Sidebar</a></li>
                                        <li><a href="shop-grid-right-sidebar.html"><i class="fa fa-circle"></i>Shop Grid
                                                Right
                                                Sidebar</a></li>
                                        <li><a href="shop-list-left-sidebar.html"><i class="fa fa-circle"></i>Shop List
                                                Left
                                                Sidebar</a></li>
                                        <li><a href="shop-list-right-sidebar.html"><i class="fa fa-circle"></i>Shop List
                                                Right
                                                Sidebar</a></li>
                                        <li><a href="product-details.html"><i class="fa fa-circle"></i>Product
                                                Details</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Men</a></li>
                                ...
                                <li class="shortcode"><a href="#">Shortcode</a>
                                    <div class="mega-menu">
                                        <span>
                                            ...
                                            <a href="shortcode-breadcrumb.html"><i
                                                    class="fa fa-circle"></i>breadcrumb</a>
                                        ...
                                        <span>
                                            ...
                                            <a href="shortcode-newsletter.html"><i
                                                    class="fa fa-circle"></i>newsletter</a>
                                            ...
                                            <a href="shortcode-pagination.html"><i
                                                    class="fa fa-circle"></i>pagination</a>
                                        </span>
                                        <span>
                                            <a class="title" href="shop-grid-left-sidebar.html">Shortcode</a>
                                            <a href="shortcode-progressbar.html"><i
                                                    class="fa fa-circle"></i>progressbar</a>
                                            <a href="shortcode-services.html"><i class="fa fa-circle"></i>services</a>
                                            <a href="shortcode-testimonial.html"><i
                                                    class="fa fa-circle"></i>testimonial</a>
                                            <a href="shortcode-slider-bottom.html"><i class="fa fa-circle"></i>Slider
                                                Bottom</a>
                                            <a href="shortcode-off-banner.html"><i class="fa fa-circle"></i>Off
                                                Banner</a>
                                        ...
                                        <span>
                                            ...
                                            <a href="rotate-text-three.html"><i class="fa fa-circle"></i>Rotate Text
                                                3</a>
                                            <a href="rotate-text-four.html"><i class="fa fa-circle"></i>Rotate Text
                                                4</a>
                                            <a href="rotate-text-five.html"><i class="fa fa-circle"></i>Rotate Text
                                                5</a>
            ...
            <!-- header end -->
            <!-- fixed image start -->
            <div class="animated-background overlay">
                <div class="video-banner text-center">
                    <div id="bgndVideo" class="player"
                        data-property="{videoURL:'https://youtu.be/GZSbYCh4UMM',containment:'.animated-background',autoPlay:true, mute:true, startAt:0, stopAt:15, opacity:1}">
                        My video</div>
                    <div class="banner-content static-text">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="nivo_text nivo_text-2">
                                        <div class="nivo_text-wrapper">
                                            ...
                                            <div class="slider-content slider-text-2 text-left">
                                                <h1 class="cd-headline letters rotate-2">
                                                    <span>SHIRT’S FOR </span>
                                                    <span class="cd-words-wrapper">
                                                        <b class="is-visible text-uppercase">Men</b>
                                                        <b class="text-uppercase">women</b>
                                                        <b class="text-uppercase">children</b>
                                                        <b class="text-uppercase">senior</b>
                                                    </span>
                                                </h1>
                                            </div>
                            ...
                            <div class="section-tab">
                                <div class="section-tab-menu text-center mb-45">
                                    <ul class="nav justify-content-center" role="tablist">
                                        <li role="presentation" class="text-uppercase"><a class="active " href="#new"
                                                aria-controls="new" role="tab" data-toggle="tab">New Arrival</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#featured"
                                                aria-controls="featured" role="tab" data-toggle="tab">Featured</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#best"
                                                aria-controls="best" role="tab" data-toggle="tab">Best Selling</a></li>
                                    </ul>
                                </div>
                                <div class="tab-content">
                                    <div id="new" role="tabpanel" class="tab-pane active show section-tab-item">
                                                ...
                                                <div class="single-product">
                                                    <div class="single-product-item clearfix">
                                                        <div class="single-product-img clearfix">
                                                            <a href="#">
                                                                <img class="primary-image" src="img/product/1.jpg"
                                                                    alt="product">
                                                            </a>
                                                            <div class="wish-icon-hover text-center clearfix">
                                                                <div class="hover-text">
                                                                    <p>Duis autem vel eum iriure dolor in hendrerit in
                                                                        tate velit esse lestiesequat </p>
                                                                    <ul>
                                                                        <li><a href="#" data-toggle="tooltip"
                                                                                title="Shopping Cart"><i
                                                                                    class="fa fa-shopping-cart"></i></a>
                                                                        </li>
                                                                        <li><a class="modal-view" href="#"
                                                                                data-toggle="modal"
                                            ...
                                            <div class="col-lg-12 col-width">
                                                <div class="single-product">
                                                    <div class="single-product-item">
                                                        <div class="single-product-img clearfix">
                                                            <a href="#">
                                                                <img class="primary-image" src="img/product/2.jpg"
                                                                    alt="">
                                                            </a>
                                                            <div class="wish-icon-hover text-center clearfix">
                                                                <div class="hover-text">
                                                ...
                                                <div class="single-product">
                                                    <div class="single-product-item">
                                                        <div class="single-product-img clearfix hover-effect">
                                                            <a href="#">
                                                                <img class="primary-image" src="img/product/3.jpg"
                                                                    alt="">
                                                            </a>
                                                            <div class="wish-icon-hover text-center clearfix">
                                                                <div class="hover-text">
                                            ...
                                            <div class="col-lg-12 col-width">
                                                <div class="single-product">
                                                    <div class="single-product-item">
                                                        <div class="single-product-img clearfix">
                                                            <a href="#">
                                                                <img class="primary-image" src="img/product/4.jpg"
                                                                    alt="">
                                                            </a>
                                                            <div class="wish-icon-hover text-center clearfix">
                                                                <div class="hover-text">
                                            ...
                                            <div class="col-lg-12 col-width">
                                                <div class="single-product">
                                                    <div class="single-product-item">
                                                        <div class="single-product-img clearfix">
                                                            <a href="#">
                                                                <img class="primary-image" src="img/product/5.jpg"
                                                                    alt="">
                                                            </a>
                                                            <div class="wish-icon-hover text-center clearfix">
                                                                <div class="hover-text">
                                    ...
                                    <div id="featured" role="tabpanel" class="tab-pane section-tab-item">
                                        <div class="tab-item-slider">
                                            <div class="col-lg-12 col-width">
                                                <div class="single-product">
                                                    <div class="single-product-item">
                                    ...
                                    <div id="best" role="tabpanel" class="tab-pane section-tab-item">
                                        <div class="tab-item-slider">
                                            <div class="col-lg-12 col-width">
                                                <div class="single-product">
                                                    <div class="single-product-item">
                        ...
                        <div class="col-lg-12">
                            <div class="section-tab">
                                <div class="section-tab-menu mb-45 text-center">
                                    <ul class="nav justify-content-center" role="tablist">
                                        <li role="presentation" class="text-uppercase"><a class="active"
                                                href="#featured1" aria-controls="featured1" role="tab"
                                                data-toggle="tab">Featured</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#trendy"
                                                aria-controls="trendy" role="tab" data-toggle="tab">Trendy</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#best1"
                                                aria-controls="best1" role="tab" data-toggle="tab">Best Selling</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 d-none d-lg-block">
                            <div class="featured-left mt-2">
                                ...
                                <span class="red d-none d-lg-block hidden-sm" style="margin-left: 35px">hot</span>
                            </div>
                            <div class="single-product-info clearfix">
                                <div class="pro-title">
                                    <h3><a href="#">Electria Ostma</a></h3>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="tab-content">
                                <div id="featured1" role="tabpanel" class="tab-pane active show section-tab-item">
                                        ...
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                                            <img class="primary-image" src="img/product/6.jpg"
                                                                alt="product">
                                                        </a>
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                                                <p class="d-block d-lg-none d-xl-block">Duis autem vel
                                                                    eum iriure dolor in hendrerit in tate velit esse
                                                                    lestiesequat </p>
                                                                <ul>
                                                                    <li><a href="#" data-toggle="tooltip"
                                                                            title="Shopping Cart"><i
                                                                    ...
                                                                    <li><a class="modal-view" href="#"
                                                                            ...
                                                                            data-target="#productModal"><i
                                                                                class="fa fa-eye"></i></a></li>
                                                                    <li class="d-block d-lg-none d-xl-block"><a href="#"
                                                                            data-toggle="tooltip" title="Compage"><i
                                                                                class="fa fa-refresh"></i></a></li>
                                                                    <li><a href="#" data-toggle="tooltip"
                                                                            title="Like it!"><i
                                                                                class="fa fa-heart"></i></a></li>
                                                ...
                                                <span class="black d-none d-lg-block">new</span>
                                            </div>
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                                            <img class="primary-image" src="img/product/9.jpg"
                                                                alt="product">
                                                        </a>
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                                ...
                                                <span class="red d-none d-lg-block">hot</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                                            <img class="primary-image" src="img/product/7.jpg"
                                                                alt="product">
                                                        </a>
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                            ...
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                                            <img class="primary-image" src="img/product/10.jpg"
                                                                alt="product">
                                                        </a>
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                                ...
                                                <span class="green d-none d-lg-block">sale</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                                            <img class="primary-image" src="img/product/8.jpg"
                                                                alt="product">
                                                        </a>
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                            ...
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                                    <div class="single-product-img clearfix">
                                                        <a href="#">
                                                            <img class="primary-image" src="img/product/11.jpg"
                                                                alt="product">
                                                        </a>
                                                        <div class="wish-icon-hover text-center clearfix">
                                                            <div class="hover-text">
                                ...
                                <div id="trendy" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                ...
                                <div id="best1" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-tab">
                                <div class="section-tab-menu mb-45 text-center">
                                    <ul class="nav justify-content-center" role="tablist">
                                        <li role="presentation" class="text-uppercase"><a class="active" href="#dress"
                                                aria-controls="dress" role="tab" data-toggle="tab">dress</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#tops"
                                                aria-controls="tops" role="tab" data-toggle="tab">tops</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#handbags"
                                                aria-controls="handbags" role="tab" data-toggle="tab">handbags</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="clearfix"></div>
                            <div class="tab-content">
                                <div id="dress" role="tabpanel" class="tab-pane active show section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                ...
                                <div id="tops" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                ...
                                <div id="handbags" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="offer-info mt-40 text-center">
                                <h3>GET IT NOW</h3>
                                <h1>LIMITED OFFER</h1>
                                <h5 class="d-none d-sm-block">HANDBAGS COLLECTION FOR WOMEN</h5>
                            </div>
                            <div class="timer">
                                <div data-countdown="2020/01/01" class="timer-grid"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-tab">
                                <div class="section-tab-menu mb-45 text-center">
                                    <ul class="nav justify-content-center" role="tablist">
                                        <li role="presentation" class="text-uppercase"><a class="active" href="#coats"
                                                aria-controls="coats" role="tab" data-toggle="tab">coats</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#shirts"
                                                aria-controls="shirts" role="tab" data-toggle="tab">shirts</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#accessories"
                                                aria-controls="accessories" role="tab" data-toggle="tab">accessories</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="clearfix"></div>
                            <div class="tab-content">
                                <div id="coats" role="tabpanel" class="tab-pane active show section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                ...
                                <div id="shirts" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
                                ...
                                <div id="accessories" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="feature-slider">
                                        <div class="col-lg-12 col-width">
                                            <div class="single-product">
                                                <div class="single-product-item clearfix">
            ...
            <div class="newsletter-area ptb-110">
                <div class="container">
                    <div class="newsletter-info row">
                        <div class="col-xl-4 col-lg-5">
                            <div class="news-left text-left">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="news-right text-center">
                                <form action="#" id="mc-form" class="mc-form">
                                    <input id="mc-email" type="text" name="email"
                                        placeholder="Type Your Email Address...">
                                    <button id="mc-submit" type="submit" class="text-uppercase">send</button>
                                    <span class="d-none d-md-block"><input type="checkbox" name="agree">By Subscribing
                                        to our newsletter you are agree to receive emails from us !</span>
                                </form>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-tab">
                                <div class="section-tab-menu mb-45 text-center">
                                    <ul class="nav justify-content-center" role="tablist">
                                        <li role="presentation" class="text-uppercase"><a class="active" href="#blog"
                                                aria-controls="blog" role="tab" data-toggle="tab">from blog</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#tweet"
                                                aria-controls="tweet" role="tab" data-toggle="tab">latest tweet</a></li>
                                        <li role="presentation" class="text-uppercase"><a href="#instagram"
                                                aria-controls="instagram" role="tab" data-toggle="tab">instagram</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="clearfix"></div>
                            <div class="tab-content">
                                <div id="blog" role="tabpanel" class="tab-pane active show section-tab-item">
                                    <div class="row">
                                            ...
                                            <div class="single-blog">
                                                ...
                                                <div class="single-blog-info mt-25">
                                                    ...
                                                    <p>But I must explain to you how all this mistaken idea of
                                                        denouncing pleasure and praising pain was bornad will give you a
                                                        complete pain was praising</p>
                                                    <div class="button-comments">
                                                        <div class="read-button text-center">
                                                            <a class="read-more text-uppercase" href="blog.html">read
                                        ...
                                        <div class="col-lg-4 d-none d-lg-block">
                                            ...
                                            <div class="single-blog-list d-block d-lg-none d-xl-block">
                                                <div class="blog-date mr-25 text-center">
                                                    <h2>09 <span>Feb</span></h2>
                                                </div>
                                                <div class="blog-list-info single-blog-info mb-25">
                                ...
                                <div id="tweet" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="single-twitter mb-10">
                                                ...
                                                <div class="twitter-feed">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur
                                                        maiores rem dolores. <a>-jan 18, 2019</a></p>
                                                </div>
                                            </div>
                                            <div class="single-twitter mb-10">
                                                <div class="twitter-icon">
                                ...
                                <div id="instagram" role="tabpanel" class="tab-pane section-tab-item">
                                    <div class="row mb-25">
                                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-4 col-md-3">
                            <div class="testimonial-left text-right">
                                ...
                                <p class="d-none d-lg-block">But I must explain to you how all this mistaken idea of
                                    denouncing pleasure and praising pain was bornad</p>
                            </div>
                        </div>
                                ...
                                <div class="testimonial-right">
                                    ...
                                    <div class="testimonial-info">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor incididunt ut labore et lore magna aliqua. Ut enim ad minim veniam
                                            quis</p>
                                    </div>
                                </div>
                                <div class="testimonial-right">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="touch-left">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adi elit, sed do eiusmod tempor incididunt ut
                                    ore dolore magna aliqua. Ut enim ad minim eniam</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adi elit, sed do eiusmod tempor incididunt ut
                                </p>
                        ...
                        <div class="col-lg-8">
                            <div class="touch-right">
                                ...
                                <form id="contact-form-two" action="https://preview.hasthemes.com/shofixe-preview/shofixe/mail.php" method="post">
                                    <input type="text" placeholder="Your name here..." name="name">
                                    <input type="text" placeholder="Your email here..." name="email">
                                    <textarea class="mtb-25" cols="30" rows="10" placeholder="Write message here..."
                ...
                <div class="footer-bottom-area ptb-25">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="copyright">
                                    <p>Copyright @ 2019 <span><a href="#">DevItems</a></span>. All right reserved. </p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="footer-menu text-center">
                                    <nav>
                                        <ul class="d-flex">
                                            ...
                                            <li class="d-none d-xl-block"><a href="wishlist.html">Wish List</a></li>
