                                ...
                                <div class="section-tab">
                                    <div class="section-tab-menu text-center mb-45">
                                        <ul class="nav justify-content-center" role="tablist">
                                            <li role="presentation" class="text-uppercase"><a class="active " href="#new" aria-controls="new" role="tab" data-toggle="tab">New Arrival</a></li>
                            ...
                            <div class="col-lg-12">
                                <div class="section-tab">
                                    <div class="section-tab-menu mb-45 text-center">
                                        <ul class="nav justify-content-center" role="tablist">
                                            <li role="presentation" class="text-uppercase"><a class="active" href="#featured1" aria-controls="featured1" role="tab" data-toggle="tab">Featured</a></li>
                                                ...
                                                <div class="single-product">
                                                    <div class="single-product-item clearfix">
                                                        <div class="single-product-img clearfix">
                                                            ...
                                                            <div class="wish-icon-hover text-center clearfix">
                                                                <div class="hover-text">
                                                                    <p class="d-block d-lg-none d-xl-block">Duis autem vel eum iriure dolor in hendrerit in tate velit esse lestiesequat  </p>
                                                                    <ul>
                                                                        <li><a href="#" data-toggle="tooltip" title="Shopping Cart"><i class="fa fa-shopping-cart"></i></a></li>
                                                                        <li><a class="modal-view" href="#" data-toggle="modal" data-target="#productModal"><i class="fa fa-eye"></i></a></li>
                                                                        <li class="d-block d-lg-none d-xl-block"><a href="#" data-toggle="tooltip" title="Compage"><i class="fa fa-refresh"></i></a></li>
                                                                        <li><a href="#" data-toggle="tooltip" title="Like it!"><i class="fa fa-heart"></i></a></li>
                                                                    </ul>
                                                                </div>    
                                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-tab">
                                    <div class="section-tab-menu mb-45 text-center">
                                        <ul class="nav justify-content-center" role="tablist">
                                            <li role="presentation" class="text-uppercase"><a class="active" href="#dress" aria-controls="dress" role="tab" data-toggle="tab">dress</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-tab">
                                    <div class="section-tab-menu mb-45 text-center">
                                        <ul class="nav justify-content-center" role="tablist">
                                            <li role="presentation" class="text-uppercase"><a class="active" href="#coats" aria-controls="coats" role="tab" data-toggle="tab">coats</a></li>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="news-right text-center">
                                    <form action="#" id="mc-form" class="mc-form">
                                        ...
                                        <span class="d-none d-md-block"><input type="checkbox" name="agree">By Subscribing to our newsletter you are agree to receive emails from us !</span>
                                    </form>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-tab">
                                    <div class="section-tab-menu mb-45 text-center">
                                        <ul class="nav justify-content-center" role="tablist">
                                            <li role="presentation" class="text-uppercase"><a class="active" href="#blog" aria-controls="blog" role="tab" data-toggle="tab">from blog</a></li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="single-twitter mb-10">
                                                    ...
                                                    <div class="twitter-feed">
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur maiores rem dolores. <a>-jan 18, 2019</a></p>
                                                    </div>
                                                </div>
                                                <div class="single-twitter mb-10">
                                                    <div class="twitter-icon">
                        ...
                        <div class="row">
                            <div class="col-xl-5 col-lg-4 col-md-3">
                                <div class="testimonial-left text-right">
                                    ...
                                    <p class="d-none d-lg-block">But I must explain to you how all this mistaken idea  of denouncing pleasure and praising pain was bornad</p>
                                </div>
                            </div>
