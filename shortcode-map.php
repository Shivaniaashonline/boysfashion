...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:44 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shortcode Map || shofixe</title>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Shortcode Map</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">Shortcode Map</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="google-address">
                                    <ul>
                                        ...
                                        <li><img src="img/icon/12.png" alt="">Telephone : +012 345 678 102 <br>Telephone : +032 225 501 172</li>
                                        <li><img src="img/icon/13.png" alt="">Email : <span><a href="#">info@example.com</a></span> <br>Web: <a href="#"> www.example.com</a></li>
                                    </ul>
                                </div>    
                            </div>     
                        </div> 
...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shortcode-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:45 GMT -->
</html>
