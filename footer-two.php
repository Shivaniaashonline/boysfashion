...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/footer-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:35 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Footer Two || shofixe</title>
        ...
        <div class="as-mainwrapper">
            <div class="bg-white">
                            ...
                            <div class="col-lg-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">Footer Two</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li class="text-capitalize"><a href="index.html">Home</a> ></li>
                                            <li class="text-capitalize">footer Two</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <footer class="footer-area">
                    <div class="footer-middle-area ptb-60">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-3 mt-18">
                                ...
                                <div class="col-xl-2 col-lg-3 col-md-3 mt-18">
                                    <div class="footer-widget">
                                        <h5>shopping info</h5>
                                        <ul>
                                            ...
                                            <li><a href="#">Current Discount</a></li>
                                ...
                                <div class="col-lg-2 d-block d-md-none d-lg-block mt-18">
                                    <div class="footer-widget">
                                        <h5>quick links</h5>
                                        <ul>
                                ...
                                <div class="col-lg-3 d-block d-md-none d-lg-block mt-18">
                    ...
                    <div class="footer-bottom-area two ptb-25">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="copyright">
                                    ...
                                    <div class="footer-menu text-right">
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a href="contact.html">Contact Us</a></li>
                                                <li class="d-none d-lg-block"><a href="wishlist.html">Wish List</a></li>
