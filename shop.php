...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:41 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="bg-white">
                ...
                <div class="shop-area mt-90">
                    <div class="container">
                                ...
                                <div class="col-xl-4 col-lg-3 col-5">
                                    <div class="shop-tab clearfix">
                                        ...
                                        <ul class="nav" role="tablist">
                                            <li role="presentation"><a class="active" data-toggle="tab" role="tab" aria-controls="grid" class="grid-view" href="#grid"><i class="fa fa-th"></i></a></li>
                                ...
                                <div class="col-lg-4 col-7">
                                    <div class="page-menu float-right">     
                                        <ul>
                                            ...
                                            <li><a href="#">2</a></li>
                                            <li class="d-none d-sm-block"><a href="#">3</a></li>
                                            <li class="d-none d-sm-block"><a href="#">4</a></li>
                        ...
                        <div class="tab-content mt-25">
                            <div id="grid" class="tab-pane show active" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-width d-block d-md-none d-lg-block">
                                        <div class="single-product mb-30">
                                            <div class="single-product-item clearfix">
                                                <div class="single-product-img clearfix">
                                                    <a href="#">
                                        ...
                                        <div class="shop-left-sidebar">
                                            <div class="single-left-widget">
                                                <div class="section-title">
                                                    ...
                                                    <ul>
                                                        <li class="active"><a href="#"><i class="fa fa-angle-right"></i>Men's Collection (275)</a>
                                                        </li>
                                                        ...
                                                        <div class="col-xl-9 col-lg-8 col-md-8">
                                                            <div class="single-product-info mt-30 clearfix">
                                                                ...
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                                                    incididunt utore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                                                    exercitation ullamco laboris nisi ut aliquip reprehenderit. </p>
                                                            </div>
                        ...
                        <div class="row">
                            <div class="shop-item-filter mb-25 d-flex">
                                <div class="col-xl-4 col-lg-3 col-5">
                                    <div class="shop-tab clearfix">
                                        <!-- Nav tabs -->
                                        <ul class="nav" role="tablist">
...
<!-- Mirrored from preview.hasthemes.com/shofixe-preview/shofixe/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2022 05:37:42 GMT -->
</html>
